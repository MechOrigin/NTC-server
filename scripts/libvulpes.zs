...
//jei
mods.jei.JEI.removeAndHide(<libvulpes:productdust:0>);
...
//adv rocketry stuff
mods.advancedrocketry.CuttingMachine.removeRecipe(<advancedrocketry:wafer:0>);
mods.advancedrocketry.CuttingMachine.addRecipe(<advancedrocketry:wafer:0>*4, 80, 100, <appliedenergistics2:material:5>*1);
